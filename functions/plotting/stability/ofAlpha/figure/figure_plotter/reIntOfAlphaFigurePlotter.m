function [figure_handle] = reIntOfAlphaFigurePlotter(data_raw, alphas, options)
%REINTALPHAPLOTTER calls ofAlphaXYPlotter to plot the length of real stability interval as a function of the 
...
%                         to the real stability interval a as a function of alpha for one method.
...
default_field_value_pairs = {
    {'YLabel',  '\beta - Real Stability Interval'}
    {'YAxis',   'default'}
};
