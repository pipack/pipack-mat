function [int_lens] = imIntOfAlpha(method, alphas, options)
%THETAOFALPHA computes length of the stability interval of a method along a ray r * 1i over a range of alphas.
% == Parameters ========================================================================================================
%
...
int_lens = rayIntOfAlpha(method, alphas, pi/2, options);
end