function [flags] = isReStableOfAlpha(method, alphas, options)
%RESTABLEOFALPHA determines if method is stable along real axis over a range of alphas
% == Parameters ========================================================================================================
%
...
flags = genericOfAlpha(@isReStable, method, alphas, options);
end