function [BLKGenerator, MG] = BG_iCheb_BAM_SMFCmj_VI(node_precision, node_ordering)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('SMVO', 'SMFOmj', VariableInputEPG(), 'diagonally_implicit') ...
    ));
