function [BLKGenerator, MG] = BG_iCheb_BAM_PMFCmj_FI3(node_precision, use_spmd)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('PMFO', 'PMFOmj', FixedInputEPG(struct('l', 3)), 'diagonally_implicit') ...
    ));
