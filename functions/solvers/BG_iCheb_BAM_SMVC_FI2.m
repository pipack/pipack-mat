function [BLKGenerator, MG] = BG_iCheb_BAM_SMVC_FI2(node_precision)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('SMVO', 'SMVO', FixedInputEPG(struct('l', 2)), 'diagonally_implicit') ...
    ));
