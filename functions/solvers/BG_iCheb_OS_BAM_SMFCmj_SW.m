function [BLKGenerator, MG] = BG_iCheb_OS_BAM_SMFCmj_SW(node_precision)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('SMVO', 'SMFOmj', SweepingEPG(), 'diagonally_implicit') ...
    ));
