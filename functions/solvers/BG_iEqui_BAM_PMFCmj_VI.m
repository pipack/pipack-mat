function [BLKGenerator, MG] = BG_iEqui_BAM_PMFCmj_VI(node_precision, use_spmd)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('PMFO', 'PMFOmj', VariableInputEPG(), 'diagonally_implicit') ...
    ));
