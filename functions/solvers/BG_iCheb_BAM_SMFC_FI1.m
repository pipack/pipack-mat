function [BLKGenerator, MG] = BG_iCheb_BAM_SMFC_FI1(node_precision)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('SMVO', 'SMFO', FixedInputEPG(struct('l', 1)), 'diagonally_implicit') ...
    ));
