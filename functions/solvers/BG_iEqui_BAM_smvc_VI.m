function [BLKGenerator, MG] = BG_iEqui_BAM_smvc_VI(node_precision)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('PMFO', 'SMVO', VariableInputEPG(), 'diagonally_implicit') ...
    ));
