function [BLKGenerator, MG] = BG_iEqui_BAM_SMFC_SW(node_precision)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('SMVO', 'SMFO', SweepingEPG(), 'diagonally_implicit') ...
    ));
