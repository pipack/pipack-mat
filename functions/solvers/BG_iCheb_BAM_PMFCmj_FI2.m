function [BLKGenerator, MG] = BG_iCheb_BAM_PMFCmj_FI2(node_precision, use_spmd)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('PMFO', 'PMFOmj', FixedInputEPG(struct('l', 2)), 'diagonally_implicit') ...
    ));
