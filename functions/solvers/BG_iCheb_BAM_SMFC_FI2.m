function [BLKGenerator, MG] = BG_iCheb_BAM_SMFC_FI2(node_precision)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('SMVO', 'SMFO', FixedInputEPG(struct('l', 2)), 'diagonally_implicit') ...
    ));
