function [BLKGenerator, MG] = BG_iCheb_BAM_SMVC_FI1(node_precision)
...
MG = PBMGenerator(struct( ...
    ...
    'ODEPoly_generator', Adams_PG('SMVO', 'SMVO', FixedInputEPG(struct('l', 1)), 'diagonally_implicit') ...
    ));
