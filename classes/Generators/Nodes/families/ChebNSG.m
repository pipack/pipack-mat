...
% ======================================================================================================================
% Chebyshev Nodes : z(j) = -cos(pi*(j-1)/(q-1))
% ======================================================================================================================

classdef ChebNSG < NodeSetGenerator
    ...
    methods
        ...
        function this = ChebNSG(ordering, precision, options)
