...
classdef MutableDIPBLK < DI_PBLKConst
    ...
    properties(SetAccess = protected)
        ...
        name = 'MutableDIPBLK'
        description = 'Mutable Diagonally Implicit Parallel Block Method'
        order = [];
    end
    ...
    methods
        ...
        function this = MutableDIPBLK(options)
            if(nargin == 0)
                options = struct();
            end
            this = this@DI_PBLKConst(options);
